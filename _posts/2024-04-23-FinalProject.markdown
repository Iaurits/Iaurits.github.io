...
_figure: Ratio of crashes and cars sold for the five most popular car brands_
...
_figure: Here is can be seen how the number of crashes for each car brand has evoled thorugh the past decade_
...
_figure: This plot shows a heatmap where each column corropsonds to a car brand, and the color of each square represents the procentage of this injury per car brand._
...
_Video: This video illustrated how the human body is moved during and accident_
...
_figure: A vizualazation of how frequents different acidents ocour and theire lethality/injury rate_
